export const DefaultUser: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg {...props} width='48' height='48' viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg"><title/>
